#!/usr/bin/env python3
"""Capture a screenshot of the currently open schematic window.

The image is saved on the Virtuoso host, then copied back locally when possible.

Usage::

    python 11_screenshot.py
...
def main() -> int:
    ...
    if not lib or view != "schematic":
        print("Open a schematic in Virtuoso first.")
        return 1
